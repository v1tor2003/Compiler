        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, lexer.tokenize('./input.cic')];
                case 1:
                    tokens = _a.sent();
                    ...
                    console.table((0, utils_1.formatTokensAsTable)(tokens));
                    console.log('Lista de uso dos tokens:');
                    console.table((0, utils_1.countTokenOccurrence)(tokens)
                        .sort(function (a, b) { return b.count - a.count; })
                        .map(function (_a) {
                        var tk = _a.tk, count = _a.count;
                        return ({ TOKEN: tk, USOS: count });
                    }));
                    return [2 /*return*/];
            }
        });
