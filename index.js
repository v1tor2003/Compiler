...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var lexer, tokens, _a, floatCount, integerCount;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    lexer = new lexer_1.Lexer();
                    return [4 /*yield*/, lexer.tokenize('./input.txt')];
                case 1:
                    tokens = _b.sent();
                    console.log('List of recognized tokens:');
                    console.log(tokens);
                    _a = countFloatsAndIntegers(tokens), floatCount = _a.floatCount, integerCount = _a.integerCount;
...
*/
function countFloatsAndIntegers(tokens) {
    var floatCount = 0;
    var integerCount = 0;
    ...
    return { floatCount: floatCount, integerCount: integerCount };
}
main()
